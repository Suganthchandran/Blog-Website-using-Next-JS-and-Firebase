...
import { createNewAuthor, deleteAuthor, updateAuthor } from "@/lib/firebase/author/create";
import { getAuthor } from "@/lib/firebase/author/view";
...
export default function AuthorFormContextProvider({children}) {
    ...
    return <AuthorFormContext.Provider value={{
        data,
        isLoading,
        error,
        isDone,
